...
class FieldFieldTest extends ViewsKernelTestBase {
  ...
  public function testRevisionTokenRender() {
    ...
    $this->assertEqual('Replace: 1', $view->getStyle()->getField(0, 'field_test__revision_id_1'));
    $this->assertEqual('Replace: 2', $view->getStyle()->getField(1, 'field_test__revision_id_1'));
    $this->assertEqual('Replace: 3', $view->getStyle()->getField(2, 'field_test__revision_id_1'));
    $this->assertEqual('Replace: 4', $view->getStyle()->getField(3, 'field_test__revision_id_1'));
  }
